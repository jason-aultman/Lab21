...
namespace Lab21MovieRegistration.Controllers
{
    public class RegisterMovieController : Controller
    {
        ...
        public RegisterMovieController(MovieDBContext context)
        {
            _context = context;
        }
        ...
        // GET: RegisterMovie/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: RegisterMovie/Create
